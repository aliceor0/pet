...
<div class="subBody" style="top:120px; margin-bottom:40px;">
	<div class="sub-visual-box bgImage05" data-aos="fade" data-aos-duration="1000">
		<div class="container">
	...
	<div class="submenu-box txt_c">
		<div class="submenu-wrap">
			<ul class="fs18 submenu-list">
				<li class="inline-list-item "><a href="/information/animal">반려동물 정보</a></li>
				<li class="inline-list-item "><a href="/information/traning">기초훈련 방법</a></li>
				<li class="inline-list-item "><a href="/information/hospital">동물병원 및 보호소</a></li>
			</ul>
		</div>
	</div>
</div>
