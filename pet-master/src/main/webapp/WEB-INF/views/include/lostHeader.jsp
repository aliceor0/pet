...
<div class="subBody" style="top:120px; margin-bottom:40px;">
	<div class="sub-visual-box bgImage03" data-aos="fade" data-aos-duration="1000">
		<div class="container">
	...
	<div class="submenu-box txt_c">
		<div class="submenu-wrap">
			<ul class="fs18 submenu-list">
				<li class="inline-list-item "><a href="/lost">실종강아지 제보</a></li>
				<li class="inline-list-item "><a href="/catch">실종강아지 목격</a></li>
			</ul>
		</div>
	</div>
</div>
