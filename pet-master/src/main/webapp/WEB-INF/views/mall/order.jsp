...
<%} else {%>
<div class="container" class="orderView">
    <main id="main">
      <div id="mainContent">
        <div id="middle_top">
     ...
     <table>
       ...
       <c:forEach var="item" items="${cartItems}" varStatus="status">
        ...
        <input type="hidden" style="display:none" class="cartId" value="${item.cart_id}">
           <tr >
               <td rowspan="2">
                   <img src="/image_mall/title_img/${item.img1}" alt="상품이미지" style="width:75px;">
               </td>
               <td>
                   <p>${item.title}</p>
               </td>
            ...
            <div class='sOrder_d'><!--결제 정보 DIV-->
              ...
              <table>
                <tr>
                  <td>결제방법</td>
                  <td>
	                <input type="radio" name="payment" value=1 disabled>계좌이체
	                <input type="radio" name="payment" value=2 disabled>신용/체크카드
	                <input type="radio" name="payment" value=3 checked>간편결제
	                <input type="radio" name="payment" value=4 disabled>휴대폰
	                <input type="radio" name="payment" value=5 disabled>무통장입금
                  </td>
                </tr>
              </table>
            </div>
