    ...
    function html5Upload() {	
    	...
    	//sUploadURL= '\src\main\webapp\WEB-INF\views\file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			//sUrl  :'\src\main\webapp\WEB-INF\views\file_uploader.jsp', //사진을 업로드할 서버의 경로
 	        //sCallback :'\libs\smarteditor\sample\photo_uploader\callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
